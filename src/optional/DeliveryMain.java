...
public class DeliveryMain {
    ...
    public static void main(String[] args) {
        System.out.println("1 = " + getDelivertyStatus(1L));
        System.out.println("2 = " + getDelivertyStatus(2L));
        System.out.println("3 = " + getDelivertyStatus(3L));
        System.out.println("4 = " + getDelivertyStatus(4L));
    }

    private static String getDelivertyStatus(Long orderId) {
